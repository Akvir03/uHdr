...
import ctypes, copy
import numpy as np
import core.image, core.processing, core.utils
...
def coreCcompute(img, processPipe):
    ...
    ce1_tolerance = 0.1
    ce1_edit_hue = (
        ppDict[5]["colorEditor0"]["edit"]["hue"]
        if "hue" in ppDict[5]["colorEditor0"]["edit"]
        else 0.0
    )
    ...
    ce2_tolerance = 0.1
    ce2_edit_hue = (
        ppDict[6]["colorEditor1"]["edit"]["hue"]
        if "hue" in ppDict[6]["colorEditor1"]["edit"]
        else 0.0
    )
    ...
    ce3_tolerance = 0.1
    ce3_edit_hue = (
        ppDict[7]["colorEditor2"]["edit"]["hue"]
        if "hue" in ppDict[7]["colorEditor2"]["edit"]
        else 0.0
    )
    ...
    ce4_tolerance = 0.1
    ce4_edit_hue = (
        ppDict[8]["colorEditor3"]["edit"]["hue"]
        if "hue" in ppDict[8]["colorEditor3"]["edit"]
        else 0.0
    )
    ...
    ce5_tolerance = 0.1
    ce5_edit_hue = (
        ppDict[9]["colorEditor4"]["edit"]["hue"]
        if "hue" in ppDict[9]["colorEditor4"]["edit"]
        else 0.0
    )
    ...
    mylib.full_process_5CO.argtypes = [
    ...
    mylib.full_process_5CO.restype = np.ctypeslib.ndpointer(
        dtype=ctypes.c_float, shape=(img.colorData.shape[0], img.colorData.shape[1], 3)
    )

    resDLL = mylib.full_process_5CO(
        img.colorData,
